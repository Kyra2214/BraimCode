...
class ExternalSkill:
    ...
    source_url: str = ""; commit: str = ""; signature: str = ""

class ExternalSkillAdapter:
    source_name = "external"; allowed_licenses = frozenset({"MIT", "Apache-2.0", "BSD-3-Clause"})
    def __init__(self, scanner: Callable[[str], bool] | None = None, allow_licenses: set[str] | None = None): self.scanner = scanner or self.scan_body; self.allow_licenses = frozenset(allow_licenses or self.allowed_licenses)
    @staticmethod
